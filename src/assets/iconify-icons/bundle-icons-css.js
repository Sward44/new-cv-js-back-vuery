...
// Utilisez les imports dynamiques pour charger les fichiers JSON
const require = createRequire(import.meta.url)

const sources = {
  json: [
    // Iconify JSON file (@iconify/json est un nom de package, /json/ est un répertoire où se trouvent les fichiers, puis nom du fichier)
